#!/bin/bash
#BSUB -J "jobs generation"
#BSUB -q short-gpu
#BSUB -R "span[hosts=1]"
#BSUB -R "rusage[mem=8GB]"
#BSUB -R "affinity[thread*20]"
#BSUB -oo /home/projects/zeevid/ofirlev/llm/step_zero/logs/jobs_generation.out.log
#BSUB -eo /home/projects/zeevid/ofirlev/llm/step_zero/logs/jobs_generation.err.log
