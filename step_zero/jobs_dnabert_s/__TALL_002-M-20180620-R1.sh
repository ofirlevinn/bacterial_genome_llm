#!/bin/bash
#BSUB -J "run TALL_002-M-20180620-R1"
#BSUB -q short-gpu
#BSUB -R "span[hosts=1]"
#BSUB -gpu num=1:j_exclusive=yes:gmem=5GB
#BSUB -R "rusage[mem=8GB]"
#BSUB -R "affinity[thread*20]"
#BSUB -oo /home/projects/zeevid/ofirlev/llm/step_zero/logs/TALL_002-M-20180620-R1.out.log
#BSUB -eo /home/projects/zeevid/ofirlev/llm/step_zero/logs/TALL_002-M-20180620-R1.err.log
...
--paths-file /home/projects/zeevid/ofirlev/llm/step_zero/fastq_paths/TALL_002-M-20180620-R1.txt
