#!/bin/bash
#BSUB -J "run BASE_138531-R1"
#BSUB -q short-gpu
#BSUB -R "span[hosts=1]"
#BSUB -gpu num=1:j_exclusive=yes:gmem=5GB
#BSUB -R "rusage[mem=8GB]"
#BSUB -R "affinity[thread*20]"
#BSUB -oo /home/projects/zeevid/ofirlev/llm/step_zero/logs/BASE_138531-R1.out.log
#BSUB -eo /home/projects/zeevid/ofirlev/llm/step_zero/logs/BASE_138531-R1.err.log
...
--paths-file /home/projects/zeevid/ofirlev/llm/step_zero/fastq_paths/BASE_138531-R1.txt
