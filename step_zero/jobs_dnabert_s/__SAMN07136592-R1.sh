#!/bin/bash
#BSUB -J "run SAMN07136592-R1"
#BSUB -q short-gpu
#BSUB -R "span[hosts=1]"
#BSUB -gpu num=1:j_exclusive=yes:gmem=5GB
#BSUB -R "rusage[mem=8GB]"
#BSUB -R "affinity[thread*20]"
#BSUB -oo /home/projects/zeevid/ofirlev/llm/step_zero/logs/SAMN07136592-R1.out.log
#BSUB -eo /home/projects/zeevid/ofirlev/llm/step_zero/logs/SAMN07136592-R1.err.log
...
--paths-file /home/projects/zeevid/ofirlev/llm/step_zero/fastq_paths/SAMN07136592-R1.txt
